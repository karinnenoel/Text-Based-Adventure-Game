...
def start():
    ...
    def eastRoom():
        ...
        print(
            "A bad feeling starts to grow in the pit of your stomach. Then you look up and see it!"
        )
    ...
    def southRoom():
        print(
            "When you walk into the room you notice a mess of green vines tangled against the cracked stone walls."
        )
        print(
            "You look to your left and see an old wooden door that is about to come off the hinges."
        )
        ...
        if roomThree == "1":
            print(
                "When you open the wooden door a giant venus flytrap lunges out and swallows you whole."
            )
            ...
            print(
                "When you open the metal door the wooden door springs open and a giant venus flytrap trys swalow you whole."
            )
            print(
                "Luckily, you chose the metal door and the venus flytrap could not reach you"
            )
            print("The room is empty and there is no exit.")
            print("You take a step and stand in the metal doorway.")
            print(
                "Then you ready your sword and you chop off the venus flytrap's head."
            )
            Roomthree = input(
                "Would you like to go back to the main room? Yes? or No?. "
            )
            if Roomthree == "Yes":
                start()
            elif Roomthree == "No":
            ...
            print(
                "Choose from the options I give you! Oi vey! Why must you be so difficult?"
            )
    ...
    if RoomFour == "1":
        ...
        if manroom == "2":
            print(
                "He notices you reach for your sword but he kills you before you can grab it."
            )
            print("Do you want to keep going? Yes? or No?")
            manroomone = input("What do you do? ")
            if manroomone == "Yes":
            ...
            print(
                "You swing your sword to hard and you also miss. Then you loose balance and trip. The man sees that you were going to attack so he kills you."
            )
            print("Would you like to respawn?")
            print("Yes? or No?")
            manroomone = input("What do you do? ")
